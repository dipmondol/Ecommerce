    ...
    <div class="container text-center text-md-left pt-4 pt-md-5">
      ...
      <div class="row mt-1 mt-md-0 mb-4 mb-md-0">
        ...
        <div class="col-md-3 mx-auto mt-3 mt-md-0 mb-0 mb-md-4">
          ...
          <p class="foot-desc mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima nostrum iste iusto maiores a, laudantium reprehenderit aliquam ex cumque asperiores..</p>
        ...
        <div class="col-md-3 mx-auto mt-3 mt-md-0 mb-0 mb-md-4">
          ...
          <ul class="fa-ul foot-desc ml-4">
            <li class="mb-2"><span class="fa-li"><i class="far fa-map"></i></span>Bangladesh, Dhaka-1212
            </li>
  ...
  <script type="text/javascript" src="{{asset('asset//js/mdb.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('asset//js/mdb.ecommerce.min.js')}}"></script>
  <script>
